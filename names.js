  ...
  for (var i = 0; i < adjectives.length; i++) {
    for (var j = 0; j < type.length; j++) {
      for (var k = 0; k < cities.length; k++) {
        names +=`'${adverbs[z]} ${adjectives[i]} ${type[j]} in ${cities[k]}', `
      }
    }
  }
}
...
names += ']\n'
names += 'module.exports = data;'

fs.appendFileSync('./test.js', names);
...
//
// let data = 'let data = [';
// for (let i = 0; i < adverbs.length; i += 1) {
//   data += `'${adverbs[i]}', `
// }
//
// fs.appendFileSync('./test.js', data);
